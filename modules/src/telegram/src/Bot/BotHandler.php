...
class BotHandler
{
    ...
    private function onMessage(array $message): void
    {
        ...
        // Бот керується лише кнопками в особистому чаті. Без цієї
        // перевірки будь-яке повідомлення в груповому чаті родини (де бот
        // теж стоїть — заради заявок на вступ) трактувалось як «інший
        // текст» і відкривало повне меню прямо в груповий чат, засмічуючи
        // його на кожне слово будь-кого з 50+ учасників.
    ...
    private function onCallback(array $callback): void
    {
        ...
        // Той самий приватний-чат-only заслон, що й у onMessage: кнопки
        // бота в принципі не з'являються в груповому чаті (заявки на
        // рецензію йдуть особисто рецензентам — див. ApplicationReview),
        // але це не привід довіряти чужому клієнту дотримання цього.
