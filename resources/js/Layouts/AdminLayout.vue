...
import { ref } from 'vue';
import { Blocks, CalendarDays, IdCard, LayoutDashboard, Megaphone, Menu, MessageCircle, Palette, ScrollText, Settings, ShieldCheck, Target, TrendingUp, Users, Wallet, X } from '@lucide/vue';
